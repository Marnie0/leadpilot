...
export const ar: Dictionary = {
  ...
  /* ضمّ الفريق — الآلية نفسها، لا نموذج الصلاحيات. */
  'landing.teamTitle': 'كيف تضمّ فريقك',
  'landing.teamSubtitle': 'ثلاث خطوات، ولا تخترع في أيٍّ منها كلمة مرور نيابةً عن أحد.',
  'landing.teamStep1Title': 'أرسل إليهم رابطًا',
  'landing.teamStep1Body':
    'من شاشة الفريق، أنشئ دعوة واختر الدور الذي تمنحه. أضف بريدًا إلكترونيًا فلا يقبلها غير ذلك البريد — ونرسل الرابط إليه أيضًا. واتركه دون بريد فيصبح مجرد رابط، يستخدمه مرة واحدة أول من يفتحه.',
  'landing.teamStep2Title': 'يختارون كلمة مرورهم بأنفسهم',
  'landing.teamStep2Body':
    'يفتح الرابط نموذجًا قصيرًا: الاسم، وكلمة مرور من اختيارهم، وبذلك يكتمل الحساب. لا كلمة مرور مؤقتة تُمرَّر، ولا شيء تكتبه أنت بالنيابة عنهم — وإن كانت الدعوة موجَّهة إلى بريدهم، تأكّد البريد لحظة قبولها.',
  'landing.teamStep3Title': 'وتبقى أنت من يقرّر ما يفعلونه',
  'landing.teamStep3Body':
    'غيّر دور أي شخص من الشاشة نفسها متى لم يعد مناسبًا. وعطّل حسابًا فتنتهي كل جلساته عند أول طلب تالٍ. واحذفه فيحتفظ المسار بالعمل — يصبح عملاؤه المحتملون بلا مسؤول فحسب.',

  'landing.teamFactsTitle': 'ما هو رابط الدعوة فعلًا',
  'landing.teamFact1': 'يُستخدم مرة واحدة، وينتهي بعد سبعة أيام',
  'landing.teamFact2':
    'يظهر مرة واحدة عند إنشائه. لا يُحفظ منه إلا بصمته، فلا أحد — ولا أنت — يستطيع استرجاعه',
  'landing.teamFact3': 'قابل للإلغاء في أي لحظة، وكل دعوة مدرجة بما آلت إليه',
  'landing.teamFact4': 'ولا يمنح دورًا يدير الفريق إلا المالك وحده',
  'landing.teamFactsNote':
    'أما الملكية نفسها فتُسلَّم ولا تُمنح، وللمساحة مالك واحد لا غير — تفرضه قاعدة البيانات، لا وعدٌ في الشيفرة.',
  ...
  'landing.aiSubtitle':
    'سؤال عن الطلب الذي أمامك، وسؤال عن كل شيء دفعة واحدة. كلاهما يجيب باللغة التي سألت بها، وكلاهما متوقّف حتى يشغّله أحد.',
  ...
  'landing.aiLeadPoint3': 'رسالة موجَّهة إلى العميل، جاهزة للإرسال كما هي',
  ...
  'landing.footerLinkTeam': 'ضمّ فريقك',
  'landing.footerLinkFaq': 'أسئلة',
  'landing.footerStart': 'ابدأ من هنا',
  'landing.footerLinkDemo': 'ابدأ العرض التجريبي',
  'landing.footerLinkSignup': 'أنشئ مساحة عمل',
  'landing.footerLinkSignin': 'تسجيل الدخول',
  'landing.footerContactTitle': 'من بنى هذا',
  'landing.footerContactBody':
    'ليدبايلوت عمل مطوّر واحد. وفي معرض الأعمال بقيّة المشاريع، وطريقة التواصل معه.',
  'landing.footerContact': 'تصفّح معرض الأعمال',
  'landing.footerRights': '© {year} ليدبايلوت',
